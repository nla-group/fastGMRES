...
%%
description = 'Ga41As41H72 with ILU precond, b = randn';
load 'problems/Ga41As41H72.mat'
A = Problem.A;
N = size(A,1);
...
[x,resvec,restime] = fastgmres(hA,b,tol,2000,[],[],x0,opts);
y = U\(L\x);
truetime = toc(tstart);
trueres = norm(A*y - b)/norm(b);
