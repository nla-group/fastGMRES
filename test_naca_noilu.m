% Naca12 problem without ILU preconditioning, using maximal Krylov size 500 
...
title('NACA12 without preconditioner','interpreter','latex')
set(gca,'TickLabelInterpreter','latex')
mypdf('naca_noilu_time',0.9,0.6)
...
%%
[x,Rres_mdr100,Riter_mdr100,timevec100] = RGS_GMRES_mdr(A,b,tol,100,20,1000,[],[]);
