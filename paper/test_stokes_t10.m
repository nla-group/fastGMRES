...
%
% Uses Arnoldi truncation parameter t=10.
...
solver = @(rhs) sgmres(A,rhs,500,1e15,10);
...
param.tol = 0;
param.t = 10;       % Arnoldi truncation parameter
param.s = 1000;
