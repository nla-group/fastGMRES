...
%%
description = 'naca12A without precond, b provided';
load 'problems/naca12A.mat' % contains A and b
N = size(A,1);
b = b/norm(b);
hA = @(x) A*x;
tol = 1e-6; 
...
%%
fprintf(' %3.1e (%3.1e) & %3.1e (%3.1f) & %3.1e (%3.1f) & %3.1e (%3.1f) & %3.1e (%3.1f) & %3.1e (%3.1f) & %3.1e (%3.1f) & %3.1e (%3.1f) & \\\\ \n',truetime,trueres,truetime1,trueres1,truetime3,trueres3,truetime4,trueres4,truetime5,trueres5,truetime6,trueres6,truetime7,trueres7,truetime8,trueres8)